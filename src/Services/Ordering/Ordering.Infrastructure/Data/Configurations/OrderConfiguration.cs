...
public class OrderConfiguration : IEntityTypeConfiguration<Order>
{
	public void Configure(EntityTypeBuilder<Order> builder)
	{
		...
		// OrderName as owned/value object
		...
		// BillingAddress as owned/value object
		...
		// Mapear la propiedad TotalPrice al campo privado _totalPrice
